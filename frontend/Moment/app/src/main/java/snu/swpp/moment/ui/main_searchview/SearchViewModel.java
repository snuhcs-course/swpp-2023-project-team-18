...
public class SearchViewModel extends ViewModel {
    ...
    public SearchViewModel(AuthenticationRepository authenticationRepository,
    ...
    public void completeHashtag(String query) {
        ...
        authenticationRepository.isTokenValid(new TokenCallBack() {
                ...
                searchRepository.getCompleteHashTagList(access_token, query,
                    new SearchHashTagCompleteCallBack() {
                        ...
                        public void onSuccess(List<String> hashTagList) {
                            hashtagCompletionState.setValue(
                                new HashtagCompletionState(hashTagList, null));
                        }

                        @Override
                        public void onFailure(Exception error) {
                            hashtagCompletionState.setValue(
                                HashtagCompletionState.withError(error));
            ...
            public void onFailure() {
                hashtagCompletionState.setValue(
                    HashtagCompletionState.withError(new UnauthorizedAccessException()));
                        ...
                        new SearchHashTagGetCallBack() {
                            ...
                            public void onSuccess(SearchHashtagsResponse response) {
                                Log.d("SearchViewModel",
                                    "Hashtag search successful: " + response.getSearchentries());
                                selectedHashtag.setValue(query);
                                searchState.setValue(
                                    SearchState.fromSearchHashtagsResponse(response));
                            }
